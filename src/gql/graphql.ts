...
export type BuecherQuery = {
  ...
  buecher?: Array<{
    ...
    schlagwoerter?: Array<string | null> | null;
    art?: Art | null;
    titel: { __typename?: "Titel"; titel: string };
  }> | null;
};

export const BuecherDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "buecher" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "lieferbar" } },
                { kind: "Field", name: { kind: "Name", value: "datum" } },
                { kind: "Field", name: { kind: "Name", value: "homepage" } },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "schlagwoerter" },
                },
                { kind: "Field", name: { kind: "Name", value: "art" } },
                {
                  kind: "Field",
                  name: { kind: "Name", value: "titel" },
                  selectionSet: {
                    kind: "SelectionSet",
                    selections: [
                      { kind: "Field", name: { kind: "Name", value: "titel" } },
                    ],
                  },
                },
              ],
...
} as unknown as DocumentNode<BuecherQuery, BuecherQueryVariables>;
